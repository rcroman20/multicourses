...
export default function GradesPage() {
  ...
  return (
    <DashboardLayout
      title="Grades"
      subtitle={isTeacher ? "Manage your students' grades" : "View your grades"}  contentClassName="pt-0 lg:pt-1"
    >
      <div className="flex flex-col gap-2">
        ...
        <div className="order-1 bg-white border border-gray-200 rounded-2xl p-5 shadow-sm">
        ...
        {!selectedCourseId && userCourses.length === 0 && (
          <div className="order-3 bg-white border border-gray-200 rounded-2xl p-8 text-center shadow-sm">
            <div className="h-8 w-8 mx-auto mb-4 rounded-2xl bg-blue-50 flex items-center justify-center">
        ...
        {isTeacher &&
          ...
          studentsWithGrades.length > 0 && (
            <div className="order-3 bg-white border border-gray-200 rounded-2xl p-8 text-center shadow-sm">
              <div className="h-8 w-8 mx-auto mb-4 rounded-2xl bg-gray-50 flex items-center justify-center">
              ...
              {(searchTerm || filterByStatus !== "all") && (
                <button
                  ...
                  className="inline-flex items-center gap-2 mt-4 px-4 py-2.5 bg-gray-700 text-white rounded-xl hover:shadow-lg transition-all duration-300 font-medium"
                >
                  Clear filters
                </button>
              )}
          ...
          <div className="order-3 space-y-2">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all duration-300">
              ...
              <div className="grid grid-cols-4 sm:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-4">
                <div className="bg-blue-50 border border-blue-100 rounded-xl p-2 md:p-5">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-2 md:p-5">
                  <p className="text-xs font-semibold text-blue-600  tracking-wide mb-2">
                    Evaluated
                  </p>
                  <p className="text-xl font-bold text-gray-900 text-center md:text-left">
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-xl p-2 md:p-5">
              ...
              <div className="p-6">
                {gradeSheets.length === 0 ? (
                  <div className="text-center py-10 px-4">
                    <div className="h-8 w-8 mx-auto mb-4 rounded-2xl bg-gray-100 flex items-center justify-center">
                  ...
                  <div className="space-y-3">
                    {gradeSheets.map((sheet) => {
                      ...
                      const gradedActivities = sheet.activities.filter(
                        (activity) =>
                          studentSheetData?.grades?.[activity.id]?.value !==
                          undefined,
                      ).length;
                      const periodAverage =
                        studentSheetData && gradedActivities > 0
                          ? sheet.activities.reduce((sum, activity) => {
                      ...
                      return (
                        <div
                          key={sheet.id}
                          className="border border-gray-200 rounded-xl hover:border-blue-300 hover:shadow-lg transition-all duration-300 p-5 group"
                        >
                          ...
                          <div className="space-y-2">
                            {sheet.activities.map((activity) => {
                              ...
                              return (
                                <div
                                  key={activity.id}
                                  className="grid grid-cols-1 sm:grid-cols-12 items-center gap-3 pl-4 pt-2 pb-2 pr-4 border border-gray-200 rounded-xl hover:bg-blue-50 transition-all duration-300"
                                >
                ...
                <div className="space-y-2">
                  {gradeSheets
                    ...
                    .map((sheet) => (
                      <div
                        key={sheet.id}
                        className="flex items-center justify-between p-3 border border-gray-200 rounded-xl hover:bg-blue-50 transition-all duration-300"
                      >
                        <div className="flex items-center gap-3">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead className="sticky top-0 z-10">
                      <tr className="bg-blue-50 backdrop-blur-sm border-b border-gray-200">
                    ...
                    <tbody>
                      {filteredStudents.map((student, index) => (
                        <tr
                          key={student.id}
                          className={cn(
                            "border-b border-gray-200 hover:bg-blue-50 transition-all duration-300",
                    ...
                    .map((sheet) => (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          >
                            <FileSpreadsheet
                              className={`h-4 w-4 ${sheet.isPublished ? "text-blue-500" : "text-gray-700"}`}
                            />
                          </div>
                          <div>
                            <p className="font-semibold text-gray-900">
            ...
            {gradeSheets.length === 0 && (
              <div className="bg-white border border-gray-200 rounded-2xl p-8 text-center shadow-sm">
                ...
                <Link to={`/courses/${getCourseCode()}/grade-sheets`}>
                  <Button className="inline-flex items-center gap-2 px-6 py-3 bg-blue-600 text-white rounded-xl hover:shadow-lg transition-all duration-300 font-medium">
                    <FileSpreadsheet className="h-4 w-4" />
                    Create Grade Sheet
                  </Button>
                </Link>
