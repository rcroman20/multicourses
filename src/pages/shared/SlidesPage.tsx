...
export default function SlidesPage() {
  ...
  if (loading && selectedCourseId) {
    return (
      <DashboardLayout
        title="Slides"
        subtitle="Class materials and presentations" 
      ...
      <div className="space-y-2">
        ...
        {!selectedCourseId && userCourses.length === 0 && (
          <div className="bg-white border border-gray-100 rounded-2xl p-8 text-center shadow-sm">
            ...
            {isTeacher && (
              <button className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-blue-600 text-white font-medium hover:shadow-lg transition-all duration-300">
                <Plus className="h-4 w-4" />
                    ...
                    <div className="space-y-2">
                      {recentlyViewed.slice(0, 3).map((slide) => (
                        <button
                          ...
                          className="w-full flex items-center gap-3 p-3 rounded-xl bg-gray-100 border border-blue-100 hover:border-blue-200 transition-all duration-300 group"
                        >
                  ...
                  {units.length === 0 ? (
                    <div className="text-center py-8">
                      ...
                      {isTeacher && (
                        <button
                          onClick={() => setShowUnitModal(true)}
                          className="inline-flex items-center gap-2 mt-4 px-4 py-2.5 bg-blue-600 text-white rounded-xl hover:shadow-lg transition-all duration-300 font-medium"
                        >
                          <Plus className="h-4 w-4" />
                          Create first unit
                        </button>
                    ...
                    <div className="space-y-2">
                      {units
                        ...
                        .map((unit) => (
                          <div
                            key={unit.id}
                            className="border border-gray-200 rounded-xl overflow-hidden hover:border-gray-300 transition-all duration-300 hover:shadow-sm"
                          >
                            <div className="flex items-center justify-between p-3 bg-white hover:bg-gray-100 transition-all duration-300">
                              <button
                              ...
                              >
                                <div className="flex items-center gap-3">
                                  ...
                                  <div>
                                    <span className="font-semibold text-sm block text-left text-gray-900">
                                      {unit.name}
                                    </span>
                                    <div className="flex items-center gap-2 mt-1">
                                  ...
                                  <div className="flex items-center gap-2 px-3 py-2 bg-white rounded-lg border border-gray-100">
                                    ...
                                    {isTeacher && (
                                      <button
                                        ...
                                        className="ml-auto p-1 text-blue-600 hover:bg-blue-50 rounded transition-colors hover:scale-110"
                                        title="Add week"
                                      >
                                        <Plus className="h-4 w-4" />
                                      </button>
                                            ...
                                            0 ? (
                                              ...
                                              (week.slides || [])
                                                ...
                                                .map((slide: any) => (
                                                  <div
                                                    key={slide.id}
                                                    className="flex items-center gap-2 bg-white rounded-lg border border-gray-100 hover:border-blue-200 transition-all duration-300 group"
                                                  >
                                                    <button
                                                      onClick={() =>
                                                        setSelectedSlide(
                      ...
                      <div className="mt-4 p-4 bg-blue-50 rounded-xl border border-blue-100">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                          <div className="flex items-start gap-2 p-2 bg-white/50 rounded-lg">
                            <div className="h-6 w-6 rounded bg-blue-600 text-white text-xs flex items-center justify-center font-bold">
                              1
                            </div>
                            <div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        Add a new unit to organize your content
                      </p>
                    </div>
                  </div>
                  <button
                ...
                <div className="space-y-2">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setWeekForm({ ...weekForm, topic: e.target.value })
                      }
                ...
                <div className="space-y-2">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      ...
                      <span className="ml-2 text-xs text-gray-500">
                        (Paste the Canva presentation link)
                      </span>
                    </label>
                    <input
                      type="url"
                      ...
                      onChange={(e) =>
                        setSlideForm({ ...slideForm, canvaUrl: e.target.value })
                      }
                      placeholder="https://canva.com/design/..."
                    />
                    <p className="text-xs text-gray-500 mt-2">
                      Tip: Use the "Share" button in Canva and copy the "View"
                      link
                    </p>
                  </div>
                  ...
                  <div className="flex gap-3 pt-4">
                    ...
                    <button
                      ...
                      disabled={
                        !slideForm.title.trim() || !slideForm.canvaUrl.trim()
                      }
                      className="flex-1 px-4 py-3 rounded-xl bg-blue-600 text-white hover:shadow-lg disabled:opacity-50 font-medium transition-all duration-300 flex items-center justify-center gap-2"
                    >
                      <Save className="h-4 w-4" />
