              ...
              <div className="bg-white rounded-xl p-4 border border-gray-200 shadow-sm">
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full px-4 py-2.5 pr-10 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all appearance-none cursor-pointer hover:bg-gray-100 text-sm font-medium"
                  >
      ...
      {isTeacher && (
        <div className="flex gap-2">
          <button
            ...
            className="inline-flex items-center gap-2 px-3 py-1.5 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-lg hover:shadow-lg transition-all duration-300 text-sm font-medium"
            title="Add unit"
          >
            <Plus className="h-4 w-4" />
          </button>
    ...
    <div className="mb-5">
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all text-sm font-medium"
          value={searchTerm}
                  ...
                  {filteredSlides.length > 0 && (
                    <div className="max-w-2xl mx-auto">
                      <h4 className="font-semibold text-gray-700 mb-4 text-left flex items-center gap-2">
                        ...
                        Quick Access ({filteredSlides.length} slides)
                      </h4>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {filteredSlides.slice(0, 6).map(slide => (
                          <button
                            key={slide.id}
                            onClick={() => setSelectedSlide(slide.id)}
                          ...
                          >
                            <div className="h-10 w-10 rounded-lg bg-gradient-to-br from-blue-100 to-cyan-100 flex items-center justify-center group-hover:scale-110 transition-transform">
