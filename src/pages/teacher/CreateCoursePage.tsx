...
export default function CreateCoursePage() {
 ...
 const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    ...
    const q = query(coursesRef, where('code', '==', courseData.code));
    const querySnapshot = await getDocs(q);
    
    if (!querySnapshot.empty) {
      setError(`Course code "${courseData.code}" already exists. Please use a unique code.`);
      setIsLoading(false);
      return;
    }
  ...
  return (
    ...
    >
      <div className="animate-fade-in">
        ...
        <button
                  onClick={() => navigate(-1)}
                  className="inline-flex items-center gap-2 text-sm text-gray-600 hover:text-blue-600 transition-colors font-medium mb-2"
                >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all duration-300">
              ...
              {error && (
                <div className="flex items-center gap-3 p-4 rounded-xl bg-gray-100 border border-gray-300 text-gray-800 mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      required
                    >
                      <option value="1">No credits</option>
                      <option value="2">1 Credit</option>
                      <option value="3">2 Credits</option>
                      <option value="4">3 Credits</option>
                      <option value="5">4 Credits</option>
                      <option value="6">5 Credits</option>
                    </select>
                  </div>
                </div>
                ...
                <div className="pt-6 border-t border-gray-200">
                  <div className="flex flex-col sm:flex-row items-center justify-end gap-4">
                    ...
                    <button
                      type="submit"
                      disabled={isLoading}
                      className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-8 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-colors duration-200 font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {isLoading ? (
                        <>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all duration-300">
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-3 p-3 border border-gray-200 rounded-xl hover:bg-blue-50 transition-colors duration-200">
